const Player = ({ player, onScoreChange, onDeletePlayer, isHighestScore }) => {
  ...
  return (
    <div className={`Player ${isHighestScore ? 'highest-score' : ''}`}>
      ...
      {isHighestScore && (
        <svg className="crown-icon" viewBox="0 0 44 35">
          <path
